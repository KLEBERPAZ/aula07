...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/index.jsp", "/webjars/**", "/resources/**", "/user/register").permitAll().anyRequest().authenticated()
				...
				.logoutSuccessUrl("/").permitAll().and().csrf().and().httpBasic();
	}
}
